...
use wasamo_runtime::{Alignment, ButtonStyle, TextRenderer, TypographyStyle, WidgetNode};
use windows::{
...
fn main() -> windows::core::Result<()> {
    ...
    let mut window =
        wasamo_runtime::window_create("Phase 5 Visual Check", window_w as i32, window_h as i32)?;
    ...
    // Callbacks are only invoked inside wasamo_runtime::run(), which completes first.
