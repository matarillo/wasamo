...
5. **Assistant-visible GUI evidence.** Launch + DPI-aware screenshot +
   ...
   after a tail remove back to N (or N−1) — item count visibly tracks the
...
| owner-intent-answers §3 notes 1–3 | Obligations | DD-005 (normative wording explicit), DD-002 (Q5 adjudication of the mutation form; the anticipated statement line superseded by the 2026-06-12 mutation-surface reviews), DD-007 (cap accounting before carry) |
| Mutation-surface design reviews 2026-06-12 — VISION §4.1 declarative model precludes method-statement mutation (M3); vocabulary axis split (§Method vocabulary); static-literal RHS (M3b, FD-C boundary extended); semicolon scope clarified (handler statements only) | Review input | DD-002 §Mutation surface; DD-007 matrix |
