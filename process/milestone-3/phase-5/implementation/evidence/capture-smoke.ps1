...
'@
[Win]::SetProcessDpiAwarenessContext([IntPtr](-4)) | Out-Null  # PER_MONITOR_AWARE_V2
...
[Win]::SetWindowPos($h, [IntPtr](-1), 0, 0, 0, 0, 0x0003) | Out-Null   # HWND_TOPMOST, NOMOVE|NOSIZE
[Win]::SetForegroundWindow($h) | Out-Null
Start-Sleep -Seconds 1

$wr = New-Object Win+RECT; [Win]::GetWindowRect($h, [ref]$wr) | Out-Null
$w = $wr.Right - $wr.Left; $ht = $wr.Bottom - $wr.Top
Write-Host "DPI(window)=$([Win]::GetDpiForWindow($h))  physical window rect=($($wr.Left),$($wr.Top)) ${w}x${ht}"
