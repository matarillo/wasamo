...
| M3-Phase 7 — Iteration grammar | in progress | [plan.md](phase-7/implementation/plan.md) | [preamble.md](phase-7/decisions/preamble.md) | ADR Accepted 2026-06-13; execution opened 2026-06-13; `TypedValue` pressure judged — **not adopted**, trigger-backed defer (DD-M3-P7-002); A8 target (collection binding drives widget-tree generation); positional un-keyed identity baseline |
