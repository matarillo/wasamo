# Vision Decision Record — Canonical Status of `.ui` and the Role of Internal DSLs
...
handled through the normal ADR process.
...
work that may surface concrete `.ui` extension proposals. ADRs
