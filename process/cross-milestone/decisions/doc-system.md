# Vision Decision Record — Document system redesign
...
This vision decision record records the decisions that restructure the project's
...
- `docs/architecture.md` — revision history table and document
  ...
  per-phase changes are recorded in the ADRs.
