# Vision Decision Record — M1 Acceptance Criteria and Animation Defaults
...
DD-V-001 in this vision decision record remains in effect unchanged; only the
downstream phase-level implementation decisions were redirected.
See the new ADR for the current Phase 5 plan.
