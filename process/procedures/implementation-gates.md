...
| 3 | **Parallel/derived data drift** — a parallel vector / map / index must be updated **atomically inside the same primitive** that mutates its source. | parallel vectors, derived indices, caches |
